...
print(getFilePath('logo.png'))
image1 = Image.open(getFilePath('logo.png'))
resize_image_scale = .3
image_x = 334
image_y = 114
resize_image = image1.resize ((int(image_x*resize_image_scale), int(image_y*resize_image_scale)))
